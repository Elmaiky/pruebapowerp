...
(0, _jqueryDefault.default)("#buscar").on("click", ()=>{
    let nombre = (0, _jqueryDefault.default)("#input_pokemon").val();
...
function llenarInfo(id, name, weight, height, sprites) {
    ...
    let div = (0, _jqueryDefault.default)(".datos");
    div.empty();
...
buscar.addEventListener("click", ()=>{
    ...
    fetch(`https://pokeapi.co/api/v2/pokemon/${nombre}`).then((response)=>response.json()).then((data)=>{
        const pokemon = {
            id: data.id,
            name: data.name,
            weight: data.weight,
        ...
        console.log("id:", pokemon.id, "nombre:", pokemon.name, "peso:", pokemon.weight, "altura:", pokemon.height);
    });
});
localStorage.clear();
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire7d33")
